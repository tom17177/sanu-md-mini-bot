...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/qyp4od.jpg',
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/F8praMx4nqp0bcztkWRXYQ?mode=hqrt1',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/qyp4od.jpg',
    NEWSLETTER_JID: '120363282833839832@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '94772563976',
    BOT_FOOTER: '> 120363282833839832@newsletter',
...
async function setupStatusHandlers(socket) {
    socket.ev.on('messages.upsert', async ({ messages }) => {
        ...
        try {
            if (config.AUTO_TIYPING === 'true' && message.key.remoteJid) {
                await socket.sendPresenceUpdate("Tiyping", message.key.remoteJid);
            }
...
`;
        const aliveMessage = {
            image: { url: "https://files.catbox.moe/qyp4od.jpg" },
...
// Case: bot_stats
    ...
    try {
        ...
        const activeCount = activeSockets.size;y
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: '𝚂𝙰𝙽𝙽𝚄-𝙼𝙳 ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
        ...
        },
        {
          ...
          buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝚂𝚃𝙰𝚃𝚂' },
          type: 1
        },
        {
          buttonId: `${config.PREFIX}bot_info`,
          buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙸𝙽𝙵𝙾' },
          type: 1
        }
      ],
      headerType: 1,
...
${config.PREFIX}𝙰𝙻𝙻 𝙼𝙴𝙽𝚄 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝚅𝙸𝙴𝚆 𝙲𝙼𝙳𝚂
> © 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃
`;
...
`;
    ...
    await socket.sendMessage(sender, {
      image: { url: thumbnail || 'https://files.catbox.moe/qyp4od.jpg' }, // Fallback image
      caption
    }, { quoted: fakevCard });
    ...
    break;
                ...
                case 'winfo': {
                    ...
                    try {
                        ...
                        winfoPpUrl = 'https://files.catbox.moe/qyp4od.jpg';
                    }
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳-𝙼𝙸𝙽𝙸❖❳🥷 
...
If asked "Who are you?": Reply "I'm 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳-𝙼𝙸𝙽𝙸❖❳🥷".  
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/qyp4od.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
 ...
 // Case: add - Add a member to the group
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/qyp4od.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
case 'script': {
    try {
        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
        const githubRepoURL = 'https://github.com/anethsara959-beep/TEST-MD-FACK-BOT';
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/anethsara959-beep/TEST-MD-FACK-BOT`,
        contextInfo: {
            externalAdReply: {
                title: 'Visit Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/anethsara959-beep/TEST-MD-FACK-BOT',
                sourceUrl: 'https://github.com/anethsara959-beep/TEST-MD-FACK-BOT'
            }
        }
    }, { quoted: fakevCard });
    break;
...
await socket.sendMessage(userJid, {
  image: { url: config.RCD_IMAGE_PATH },
  caption: `𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃 𝙾𝚆𝙽𝙴𝚁 𝙱𝚈 𝚂𝙰𝙽𝙽𝚄 ❖ ❳🥷
...
* SANNU-MD වෙතට සදරයයෙන් පිළිගන්නවා ඔබව🙏𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳❖ 🥷.....*
